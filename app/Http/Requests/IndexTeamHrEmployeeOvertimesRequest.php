...
class IndexTeamHrEmployeeOvertimesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort' => ['required', Rule::in(['ot_date', 'status', 'approve_date'])],
    ...
    protected function prepareForValidation(): void
    {
        ...
        if (! $this->has('sort') || ! in_array((string) $this->input('sort'), ['ot_date', 'status', 'approve_date'], true)) {
            $merge['sort'] = 'ot_date';
        }
     ...
     */
    public function inertiaTeamOvertimeFilters(): array
    {
