...
class SearchTeamHrDecisionMakerEmployeesController extends Controller
{
    public function __invoke(
        SearchTeamHrDecisionMakerEmployeesRequest $request,
        ...
        $employees = Employee::query()
            ...
            ->where(function ($search) use ($queryText): void {
                $like = '%'.$queryText.'%';
