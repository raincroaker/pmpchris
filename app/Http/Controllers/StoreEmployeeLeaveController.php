...
class StoreEmployeeLeaveController extends Controller
{
    ...
    public function __invoke(StoreEmployeeLeaveRequest $request): RedirectResponse
    {
        ...
        $explicitLeaveDays = array_key_exists('leave_days', $validated)
            ...
            : null;
        $this->employeeLeaveDaysSyncService->sync($leave, $explicitLeaveDays);
