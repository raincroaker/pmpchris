...
import { fetchTeamHrDecisionMakerEmployees } from '@/lib/teamHrFormApi';
...
const props = withDefaults(
    ...
    {
        placeholder: 'Search decision maker…',
        disabled: false,
    },
);
...
async function loadEmployees(query: string): Promise<void> {
    ...
    try {
        employees.value = await fetchTeamHrDecisionMakerEmployees({
