...
const employmentForDialog = computed(
    (): EmploymentHistoryRow | null => props.row.current_employment ?? null,
);

const employmentActionsEnabled = computed(
    (): boolean =>
        employmentForDialog.value !== null &&
        employmentForDialog.value.employment_status === 'active',
);
