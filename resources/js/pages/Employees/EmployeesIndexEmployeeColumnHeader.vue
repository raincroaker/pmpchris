...
import type { EmployeeFilters } from '@/pages/Employees/employeeIndexTypes';

const props = defineProps<{
    sort: EmployeeFilters['sort'];
    direction: EmployeeFilters['direction'];
    orgScope: EmployeeFilters['org_scope'];
}>();

const emit = defineEmits<{
    sortBy: [field: 'last_name' | 'id_number'];
    'update:orgScope': [value: EmployeeFilters['org_scope']];
}>();
...
function chooseOrgScope(scope: EmployeeFilters['org_scope']): void {
    emit('update:orgScope', scope);
}

function isOrgScopeActive(scope: EmployeeFilters['org_scope']): boolean {
