...
const selectedRoomId = ref<number | null>(
    props.selectedRoomId ?? props.rooms[0]?.id ?? null,
);
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full min-h-0 flex-1 flex-col gap-0 p-0">
            <div
                class="flex min-h-0 flex-1 flex-col overflow-hidden bg-background md:flex-row"
            >
                <aside
    ...
    <ChatGroupInfoSheet v-model:open="groupInfoOpen" :room="activeThread" />
</template>
