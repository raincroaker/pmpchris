...
return new class extends Migration
{
    ...
    {
        Schema::create('branch_calendar_events', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['organization_id', 'root_unit_id', 'starts_at'], 'branch_events_org_root_start_idx');
            $table->index(['organization_id', 'category_id'], 'branch_events_org_category_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('branch_calendar_events');
    }
};
